...
<div class="container mt-5">
    ...
    <form action="{{ route('checkout.store') }}" method="POST" class="form-horizontal">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="product_name" name="product_name" value="{{ $barang->Nama_Barang }}" readonly>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="product_price" name="product_price" value="Rp {{ number_format($barang->Harga_Barang, 0, ',', '.') }}" readonly>
            </div>
        </div>
